...
/// Translate message strings in the Anklang/ASE text domain, use @plural forms if @n != 1.
const char*
...
/// Check whether the tty @a fd should use colorization, checks ASE_COLOR if @a fd == -1.
bool
colorize_tty (int fd)
{
  if (fd >= 0)
