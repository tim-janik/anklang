...
bool         memwrite            (const String &filename, size_t len, const uint8 *bytes, bool append = false, int perms = -1);
String       stringread          (const String &filename, ssize_t maxlength = -1);
bool         stringwrite         (const String &filename, const String &data, bool mkdirs = false, int perms = -1);
bool         stringappend        (const String &filename, const String &data, bool mkdirs = false, int perms = -1);
String       cwd                 ();
