...
// == cent_table ==
static const float cent_table201[100 + 1 + 100] = {
...
const float *const cent_table = cent_table201 + 100;

// == musical tuning tables ==
...
const float *const semitone_tables_265[17] = {
  ...
  132 + semitone_table265_equal_temperament_12_tet,
  132 + semitone_table265_equal_temperament_7_tet,
  132 + semitone_table265_equal_temperament_5_tet,
  // Rational Intonation: http://en.wikipedia.org/wiki/Just_intonation
  132 + semitone_table265_diatonic_scale,
  132 + semitone_table265_indian_scale,
  132 + semitone_table265_pythagorean_tuning,
  132 + semitone_table265_pentatonic_5_limit,
  132 + semitone_table265_pentatonic_blues,
  132 + semitone_table265_pentatonic_gogo,
  // Meantone Temperament: http://en.wikipedia.org/wiki/Meantone_temperament
  132 + semitone_table265_quarter_comma_meantone,
  132 + semitone_table265_silbermann_sorge_temperament,
  // Well Temperament: http://en.wikipedia.org/wiki/Well_temperament
  132 + semitone_table265_werckmeister3_temperament,
  132 + semitone_table265_werckmeister4_temperament,
  132 + semitone_table265_werckmeister5_temperament,
  132 + semitone_table265_werckmeister6_temperament,
  132 + semitone_table265_kirnberger_temperament,
  132 + semitone_table265_young_temperament,
};
static_assert (sizeof (semitone_tables_265) / sizeof (semitone_tables_265[0]) == 1 + int (MusicalTuning::YOUNG));
