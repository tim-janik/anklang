...
jsonipc_for_api_jsonipc_json()
{
  ...
  class__Ase_Property
    ...
    .set ("set_metadata", &::Ase::Property::set_metadata)
  ...
  class__Ase_Track
    .inherit< ::Ase::Device >()
    .set ("volume", &::Ase::Track::get_volume, &::Ase::Track::set_volume)
    .set ("pan", &::Ase::Track::get_pan, &::Ase::Track::set_pan)
    ...
    .set ("get_volume", &::Ase::Track::get_volume)
    .set ("set_volume", &::Ase::Track::set_volume)
    .set ("get_pan", &::Ase::Track::get_pan)
    .set ("set_pan", &::Ase::Track::set_pan)
  ...
  class__Ase_Project
    ...
    .set ("master_volume", &::Ase::Project::get_master_volume, &::Ase::Project::set_master_volume)
    .set ("set_bpm", &::Ase::Project::set_bpm)
    .set ("get_bpm", &::Ase::Project::get_bpm)
    .set ("set_numerator", &::Ase::Project::set_numerator)
    .set ("get_numerator", &::Ase::Project::get_numerator)
    .set ("set_denominator", &::Ase::Project::set_denominator)
    .set ("get_denominator", &::Ase::Project::get_denominator)
    ...
    .set ("get_length", &::Ase::Project::get_length)
    .set ("get_master_volume", &::Ase::Project::get_master_volume)
    .set ("set_master_volume", &::Ase::Project::set_master_volume)
