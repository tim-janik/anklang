...
jsonipc_for_api_jsonipc_json()
{
  ...
  class__Ase_Track
    ...
    .set ("is_control_track", &::Ase::Track::is_control_track)
    ...
    .set ("launcher_clips", &::Ase::Track::launcher_clips, &::Ase::Track::launcher_clips)
  ...
  class__Ase_Server
    ...
    .set ("ui_js_fetch", &::Ase::Server::ui_js_fetch)
