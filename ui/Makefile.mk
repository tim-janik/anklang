...
# == ui/global.css ==
ui/tailwind.inputs := $(wildcard ui/*.html ui/*.*css ui/*.*js ui/b/*.*js)
$>/ui/global.css: ui/global.scss $(ui/tailwind.inputs) $(ext/ui/b/js.files) ui/stylelintrc.cjs ui/postcss.config.mjs $(UI/GLOBALSCSS_IMPORTS)	| $>/ui/
	$(QGEN)
...
# == all-components.js ==
$>/ui/all-components.js: ui/Makefile.mk $(wildcard ui/b/*)	| $>/ui/
	$(QGEN)
